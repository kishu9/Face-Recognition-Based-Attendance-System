...
window.configure(background='#591D53')

frame1 = tk.Frame(window, bg="#591D6B")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#59366B")
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,
    fg="black"  ,bg="#ea2a2a"  ,width=11 ,activebackground = "white" ,font=('times', 11, ' bold '))
